<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingSelect :selectType="selectType" :onlyContent="onlyContent" :desc = 'desc' :ratings = 'ratings' @ratingtype-select="onSelectType" @content-toggle="contentToggle"></ratingSelect>
